    ...
    public class Card
    {
        ...
        public static List<Card> GetAllPossibleCards()
        {
            return new List<Card>
            {
                ...
                new Card("Chef Ornitho", CardRarity.Rare, "/Images/Cards/rares/cuisinier rare.png","Mangez sainement est ensentiel pour la concentration"),
                ...
                new Card("Œil de Mouche", CardRarity.Rare, "/Images/Cards/rares/mouche rare.png","Grade une bonne higiène de vie, pour restez a fond"),
