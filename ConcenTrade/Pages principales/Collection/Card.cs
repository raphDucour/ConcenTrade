    ...
    public class Card
    {
        ...
        public static List<Card> GetAllPossibleCards()
        {
            return new List<Card>
            {
                ...
                new Card("Chef Ornitho", CardRarity.Rare, "/Images/Cards/rares/cuisinier rare.png","Prépare-toi une collation saine avant de bosser."),
                ...
                new Card("Koala Cool", CardRarity.Rare, "/Images/Cards/rares/koala rare.png","Fais une bonne nuit : focus vient du repos."),
                new Card("Œil de Mouche", CardRarity.Rare, "/Images/Cards/rares/mouche rare.png","Élimine les distractions visuelles, reste sur ta cible."),
                new Card("Mélodie du Panda", CardRarity.Rare, "/Images/Cards/rares/panda.png","Laisse-toi porter par le rythme de ta respiration."),
                new Card("Ver de Livre", CardRarity.Rare, "/Images/Cards/rares/verre de terrre rare.png","Lis 5 min pour calmer ton esprit agité."),
                new Card("Zèbre Zêrbe", CardRarity.Rare, "/Images/Cards/rares/zebre rare.png","Détends-toi profondément, puis reviens ultra focus."),
