...
namespace Concentrade
{
    public partial class QuestionSexe : Page
    {
        ...
        {
            SexeInput.Focus(); // 👈 donne immédiatement le focus clavier à la ComboBox
        }
        ...
        private void Page_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                else if (_etapeCombo == 1)
                {
                    ...
                    SexeInput.IsDropDownOpen = false;
                    _etapeCombo = 2;
